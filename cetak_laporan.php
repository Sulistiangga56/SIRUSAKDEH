...
$data_pendaftar = query ("SELECT pasien.kode_pendaftaran,pasien.tgl_daftar,pasien.nama,poliklinik.nama_poli,dokter.nama_dokter,jam.jam,pasien.status,pasien.diagnosa from pasien join poliklinik on pasien.id_poli=poliklinik.id_poli join dokter on pasien.id_dokter=dokter.id_dokter join jam on pasien.id_jam=jam.id_jam
            WHERE tgl_daftar
              ");
  ...
  <div class=row>
    <div class=col-sm-4 mb-3>
      <table class=table table-bordered>
        <tr>
        <td width=180 rowspan=2><center><img src="img/logo.png" style="width: 150px; background: transparent;"></center></td>
          <td width=500><center><h2> DATA REKAPILUTASI PENDAFTARAN ONLINE</h2></center></td>
        </tr>
        <tr>
          <td width=600><center><h2>PASIEN RAWAT JALAN POLIKLINIK RUMAH SAKIT DAMAI ELOK HOSPITAL</h2>
          <font size=3>Universitas Indonesia, Jl. Prof. DR. G.A. Siwabessy, Kukusan, Kecamatan Beji, Kota Depok, Jawa Barat 16425
          </font></center></td>
        </tr>
    </table>
    <hr>
...
<tr>
    ...
    <th><font size=3>Diagnosa</font></th>
</tr>';
$i=1;
