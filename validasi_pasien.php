...
$validasi_pasien = query("SELECT pasien.kode_pendaftaran,pasien.tgl_daftar,pasien.nama,poliklinik.nama_poli,dokter.nama_dokter,jam.jam,pasien.jenis_pembayaran,pasien.status,pasien.diagnosa from pasien join poliklinik on pasien.id_poli=poliklinik.id_poli join dokter on pasien.id_dokter=dokter.id_dokter join jam on pasien.id_jam=jam.id_jam where kode_pendaftaran = $kode_pendaftaran")[0];
        ...
        <div class="row">
                <div class="col md">
                  <form class="" action="" method="post">
                    ...
                    <div class="form-group row">
                      <label for="diagnosa" class="col-sm-2"><h6>Keterangan Diagnosa</h6></label>
                    <div class="col-sm-5">
                      <select class="form-control" name="diagnosa">
                        <option value="Perlu Perawatan Lebih lanjut" <?php if($validasi_pasien["diagnosa"] == 'Perlu Perawatan Lebih lanjut'){echo 'selected';}?>>Rawat</option>
                        <option value="Perlu Istirahat lebih banyak" <?php if($validasi_pasien["diagnosa"] == 'Perlu Istirahat lebih banyak'){echo 'selected';}?>>Istirahat</option>
                        <option value="Sudah Membaik" <?php if($validasi_pasien["diagnosa"] == 'Sudah Membaik'){echo 'selected';}?>>Sudah Membaik</option>
                      </select>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      <select class="form-control" name="status">
                        ...
                        <option value="Selesai Ditangani" <?php if($validasi_pasien["status"] == 'Selesai Ditangani'){echo 'selected';}?>>Selesai Ditangani</option>
                      </select>
                    </div>
                    </div>
